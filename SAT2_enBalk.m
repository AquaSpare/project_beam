function [w, t, x, h, k, error] = SAT2_enBalk(N,x0,xN,T, a, order, BC, plotspeed, k_ratio, IC, plotornot, timestepperversion,timestepperOrder)
...
if BC == 1 %clamped
    ...
    tau0_2 = 4/(h*alfa_2);
    tauL_2 = tau0_2;
    SAT = HI*( -(d1_2+tau0_2*d1_1)'*d1_1 + (dN_2-tauL_2*dN_1)'*dN_1);
    L = [e1;eN];
elseif BC == 2 %free
    SAT = HI*(-e1'*d1_3 + eN'*dN_3);
    L = [d1_2;dN_2];
elseif BC == 3 %sliding
    tau = 2/(h*alfa_2);
    SAT = HI*(- e1'*d1_3 + eN'*dN_3);
