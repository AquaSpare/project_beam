...
%%%% Clamped:
%%%% proj_projSAT_proj(81,-1,0,1,0.1,1,100,4,1,200, 0.00001, 0, 1, 1);

%%%% Free:
%%%% proj_projSAT_proj(81,-1,0,1,0.1,1,100,4,2,200, 0.00001, 0, 1, 1);

%%%% Sliding
%%%% proj_projSAT_proj(81,-1,0,1,0.1,1,100,4,3,200, 0.00001, 0, 1, 1);

%%%% Hinged
%%%% proj_projSAT_proj(81,-1,0,1,0.1,1,100,4,4,200, 0.00001, 0, 1, 1);

function [w,t,x,h,k,error] = proj_projSAT_proj(N, x0, xl, xN, T, a1, a2, order, BC, plotspeed, k_ratio, IC, plotornot,timestepperversion,timestepperOrder)
close all
pause on
%%%Domain%%%
h = (xN-xl)/(N-1);
