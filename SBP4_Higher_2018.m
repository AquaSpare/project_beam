...
% Fifth derivative, 0th order accurate at first 6 boundary points

q4=-1/6;q3=3/2;q2=-13/3;q1=29/6;
Q5=q4*(diag(ones(m-4,1),4)-diag(ones(m-4,1),-4))+q3*(diag(ones(m-3,1),3)-diag(ones(m-3,1),-3))+q2*(diag(ones(m-2,1),2)-diag(ones(m-2,1),-2))+q1*(diag(ones(m-1,1),1)-diag(ones(m-1,1),-1));   

%QQ3=(-1/8*diag(ones(m-3,1),3) + 1*diag(ones(m-2,1),2) - 13/8*diag(ones(m-1,1),1) +13/8*diag(ones(m-1,1),-1) -1*diag(ones(m-2,1),-2) + 1/8*diag(ones(m-3,1),-3));


Q5_U = [0 0.30059903e8 / 0.26174400e8 -0.15882103e8 / 0.6543600e7 0.6066703e7 / 0.4362400e7 -0.613703e6 / 0.6543600e7 -0.476897e6 / 0.26174400e8; -0.30059903e8 / 0.26174400e8 0 0.11737823e8 / 0.2617440e7 -0.5848583e7 / 0.1308720e7 0.2140543e7 / 0.1744960e7 -0.613703e6 / 0.6543600e7; 0.15882103e8 / 0.6543600e7 -0.11737823e8 / 0.2617440e7 0 0.2094941e7 / 0.436240e6 -0.5194223e7 / 0.1308720e7 0.6066703e7 / 0.4362400e7; -0.6066703e7 / 0.4362400e7 0.5848583e7 / 0.1308720e7 -0.2094941e7 / 0.436240e6 0 0.4058021e7 / 0.872480e6 -0.9292901e7 / 0.2181200e7; 0.613703e6 / 0.6543600e7 -0.2140543e7 / 0.1744960e7 0.5194223e7 / 0.1308720e7 -0.4058021e7 / 0.872480e6 0 0.42010901e8 / 0.8724800e7; 0.476897e6 / 0.26174400e8 0.613703e6 / 0.6543600e7 -0.6066703e7 / 0.4362400e7 0.9292901e7 / 0.2181200e7 -0.42010901e8 / 0.8724800e7 0;];

Q5(1:6,1:6)=Q5_U;
Q5(m-5:m,m-5:m)=flipud( fliplr( -Q5_U ) );
Q5=Q5/h^4;
